...
'''
    Usage :
    ./query_search.py -d "database_name" -q "query_imagename" -r "relevant_images_number" -f "features_type" -a "algoindex"
'''
...
kp, qdesc = feat_extractor.detectAndCompute(queryImage,None)
